  ...
  <section id="appPanel" class="hidden">
    ...
    <section id="dashboard" class="panel active">
      ...
      <div class="tile-grid compact-tiles">
        ...
        <button class="nav-tile" data-tab="classes" type="button"><span>🧘</span><strong>Classes</strong></button>
    ...
    <section id="classes" class="panel"><div class="card"><div class="row between gap"><div><h2>Local classes</h2><p class="muted compact">Save classes in your local area and open the provider’s booking page.</p></div><button class="primary small" type="button" disabled title="Coming in the next feature update">+ Add class</button></div><div class="empty-state"><span>🧘</span><h3>Classes directory</h3><p class="muted">This page is ready for class name, provider, time, location, cost and booking links.</p></div></div></section>
...
<script type="module" src="./app.js?v=7.0"></script>
</body>
</html>
